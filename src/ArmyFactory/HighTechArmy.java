 ...
 */
public class HighTechArmy extends Army {
	 ...
	 * 
	 * <p>This class is for high tech armies only.</p>
	 * @param s The state for which the added values should be calculated for.
	 */
	public HighTechArmy( State s ) {		
		...
		addedTanks = (int) (TANKINCREASEFACTOR * newPopulation);
		if (addedTanks == 0)
		{
			addedTanks = 1;
		}
